...
function getAssignedName(data) {
  for (let i = 0; i < data.length; i++) {
    if (data[i].task === "dropzone-kitchen") {
...
function getTodoList() {
  fetch("https://todolists-e3b5.restdb.io/rest/kitchen", {
    method: "get",
    headers: {
      "Content-Type": "application/json; charset=utf-8",
      "x-apikey": "5cb4884b814cf93287673239",
...
let form = document.querySelector("#kitchen-form");
...
function showTask(task) {
  ...
  document.querySelector("#kitchen-tasks").appendChild(clone);
}

//Delete an element by its id
function deleteTask(id) {
  fetch("https://todolists-e3b5.restdb.io/rest/kitchen/" + id, {
    method: "delete",
    headers: {
      "Content-Type": "application/json; charset=utf-8",
      "x-apikey": "5cb4884b814cf93287673239",
